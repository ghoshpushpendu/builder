export default function initBlocks(editor){
	const bm = editor.Blocks;
    
    /** Default Button **/
    const button = bm.add("primary-button",{
     ...
     /** Default Button **/
    const table = bm.add("primary-table",{
        label:"Simple Table",
        media : `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-table" viewBox="0 0 16 16">
        ...
        content: `<div class="container-fluid">
             <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">1</th>
                          <td><span>Pushpendu Ghosh</span></td>
                          <td><span>Pushpendu Ghosh</span></td>
                          <td><span>Pushpendu Ghosh</span></td>
                        </tr>
                      </tbody>
         ...
         /** Default Button **/
    const card = bm.add("simple-card",{
        label:"Simple Card",
        media : `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-heading" viewBox="0 0 16 16">
