    ...
    return (<div className="footer-dark">
        <footer>
            <div className="container">
                ...
                <p className="copyright">The Sigma Corporation © 2021 | <a  class="link-primary" style={{cursor:"pointer"}} onClick={()=>{termsandconditionpage()}}>Terms & Conditions</a> | <a  class="link-primary" style={{cursor:"pointer"}} onClick={()=>{privacypolicypage()}}>Privacy Policy</a> </p>
            </div>
        </footer>
    </div>)
}
